const Footer = () => {
  ...
  return (
    <footer className="bg-[rgba(10,34,23,1)]">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-[rgba(255,255,255,0.1)]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 text-center md:text-left text-base text-gray-400">
              <p>&copy; {currentYear} Renu. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
