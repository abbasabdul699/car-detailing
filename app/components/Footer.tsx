...
const Footer = forwardRef<HTMLDivElement, React.HTMLProps<HTMLDivElement>>((props, ref) => {
  const footerSections = {
    Company: [
      ...
      { name: 'For Detailers', href: '/for-detailers' },
    ...
    Legal: [
      ...
      { name: 'Terms', href: '/terms-page' },
      { name: 'License', href: '/license-page' }
    ]
  };
  ...
  const socialLinks = [
    { 
      name: 'Facebook', 
      href: 'https://www.facebook.com/profile.php?id=61575109101685', 
      icon: (props: any) => (
    ...
    { 
      name: 'Instagram', 
      href: 'https://www.instagram.com/reeva.ig/', 
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
