          ...
          <div className="mt-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent text-sm bg-[#f9f9f8]"
              />
              {searchQuery && (
                <button
