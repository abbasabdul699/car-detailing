      ...
      <div className="min-h-full flex flex-col">
        <div className="max-w-5xl w-full mx-auto px-4 md:px-5 py-8 md:py-12 mt-6">
          ...
          <div className="mb-10 flex items-start justify-between">
            ...
            <button
              onClick={() => window.dispatchEvent(new Event("open-onboarding-survey"))}
              className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-[#2B2B26] border transition-colors hover:bg-[#F0F0EE]"
              style={{ borderColor: "#deded9" }}
            >
